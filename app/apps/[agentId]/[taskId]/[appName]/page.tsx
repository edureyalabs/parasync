...
export default function AppPage() {
  ...
  // Inject token into iframe once it loads
  ...
  // Pass token as query param for initial HTML load auth,
  // then postMessage injects it into __APP__._token for subsequent API calls
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#fafaf8' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
          <button
            onClick={copyLink}
            style={{ ...mono, fontSize: '0.7rem', padding: '0.3rem 0.75rem', border: '1px solid #ddd', borderRadius: 4, background: copied ? '#f0faf6' : 'none', color: copied ? '#1a7f5a' : '#555', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.35rem', transition: 'all 0.15s' }}
          >
            {copied
          ...
          <button
            ...
            style={{ ...mono, fontSize: '0.7rem', padding: '0.3rem 0.75rem', border: '1px solid #ddd', borderRadius: 4, background: 'none', color: '#555', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.35rem' }}
          >
